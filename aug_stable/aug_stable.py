...
if __name__ == '__main__':
    ...
    K = 0
    clu_X_list,clu_Y_list,clu_pos_list,clu_emb_list, label_list = get_clustered_list(samples, embs)
    aug_z = get_aug_z(dataset = dataset, weak=True)
    clu_aug_label_matrix, clu_aug_label_list, clu_stability_list, stable, stable_ratio, aug_label = get_aug_stable(embs, aug_z, clu_center, clu_pos_list,K=K)
    ...
    plt.clf()
    sns.regplot(x=clu_stability_array[:,0],y=clu_entropy_list,x_ci=50)
