    ...
    for backbone in [conv4_un]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            # for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    ...
                    new_dict={
                        "model": backbone,
                        "ngpu": 1,
                        "pretrained_weights_root": "./EP/logs/pretrain-omni",
                        # Data
                        'n_classes': dataset["n_classes"],
                        "transform_train": backbone["transform_train"],
                        "transform_val": backbone["transform_val"],
    ...
    for backbone in [conv4_un_imagenet]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            # for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    ...
                    new_dict={
                        "model": backbone,
                        "ngpu": 1,
                        "pretrained_weights_root": "./EP/logs/pretrain-mini",
                        # Data
                        'n_classes': dataset["n_classes"],
                        "transform_train": backbone["transform_train"],
                        "transform_val": backbone["transform_val"],
...
EXP_GROUPS["finetune_en_mini"]=[]
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [miniimagenet_en]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4_un_imagenet]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            # for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['finetune_en_mini'] += [new_setting]

EXP_GROUPS["finetune_en_tiered"]=[]
base_setting = EXP_GROUPS['finetune'][0]
for dataset in [tiered_imagenet_en]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4_un_imagenet]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            # for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                        "model": backbone,
                        "ngpu": 2,
                        "pretrained_weights_root": "./EP/logs/pretrain-tiered",
                        # "pretrained_weights_root": "./EP/logs/pretrain-mini",
                        # Data
                        'n_classes': dataset["n_classes"],
                        "transform_train": backbone["transform_train"],
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['finetune_en_tiered'] += [new_setting]
