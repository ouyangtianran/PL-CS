...
EXP_GROUPS["pretrain_en_mini"]=[]
base_setting = EXP_GROUPS['pretrain'][0]
for dataset in [miniimagenet_en]:#, miniimagenet_en]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            # for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['pretrain_en_mini'] += [new_setting]

EXP_GROUPS["pretrain_en_tiered"]=[]
base_setting = EXP_GROUPS['pretrain'][0]
for dataset in [tiered_imagenet_en]:#, miniimagenet_en]:#[, semi_miniimagenet, miniimagenet, tiered_imagenet, cub]:
    for backbone in [conv4]:#[ conv4semi_test,resnet12_semi_norm, wrn_semi_norm]:#[conv4semi_test,conv4semi_test_basic,conv4semi_test]:#[[conv4, resnet12, wrn]:
            # for npc in [20, 100, 200]:#[20, 60, 120, 300, 540]:
                    new_setting = base_setting.copy()
                    new_dict={
                    ...
                    new_setting.update(new_dict)
                    EXP_GROUPS['pretrain_en_tiered'] += [new_setting]