...
def trainval(exp_dict, savedir_base, datadir, reset=False, 
    ...
    if args.dataset == "omniglot":
        ...
        fix_raw = True
        if weak >= 0:
            augZ_file = work_file + '/data/cfe_encodings/supply/{}_{}_augZ_K{}_weak{}{}.npz'.format(args.dataset, encoding_dim, args.K, weak, t)
            augLabel_file = work_file + '/data/cfe_encodings/supply/{}_{}_augLabel_KNN{}_K{}_weak{}{}.npz'.format(args.dataset, encoding_dim, KNN, args.K, weak, t)
            if fix_raw:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_fix_Thr{}_K{}_weak{}{}.npz'.format(args.dataset, encoding_dim, threshold, args.K, weak, t)
            else:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_Thr{}_K{}_weak{}{}.npz'.format(args.dataset, encoding_dim, threshold, args.K, weak, t)
        else:
            augZ_file = work_file + '/data/cfe_encodings/supply/{}_{}_augZ_K{}{}.npz'.format(args.dataset, encoding_dim, args.K, t)
            augLabel_file = work_file + '/data/cfe_encodings/supply/{}_{}_augLabel_KNN{}_K{}{}.npz'.format(args.dataset, encoding_dim, KNN, args.K, t)
            if fix_raw:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_fix_Thr{}_K{}{}.npz'.format(args.dataset, encoding_dim, threshold, args.K, t)
            else:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_Thr{}_K{}{}.npz'.format(args.dataset, encoding_dim, threshold, args.K, t)
        ...
        fix_raw = True
        if weak:
            augZ_file = work_file + '/data/cfe_encodings/supply/{}_{}_augZ_weak{}.npz'.format(args.dataset, encoding_dim, t)
            augLabel_file = work_file + '/data/cfe_encodings/supply/{}_{}_augLabel_KNN{}_weak{}.npz'.format(args.dataset, encoding_dim, KNN, t)
            if fix_raw:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_fix_Thr{}_weak{}.npz'.format(args.dataset, encoding_dim, threshold, t)
            else:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_Thr{}_weak{}.npz'.format(args.dataset, encoding_dim, threshold, t)
        else:
            augZ_file = work_file + '/data/cfe_encodings/supply/{}_{}_augZ{}.npz'.format(args.dataset, encoding_dim, t)
            augLabel_file = work_file + '/data/cfe_encodings/supply/{}_{}_augLabel_KNN{}{}.npz'.format(args.dataset, encoding_dim, KNN, t)
            if fix_raw:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_fix_Thr{}{}.npz'.format(args.dataset, encoding_dim, threshold, t)
            else:
                augReduce_file = work_file + '/data/cfe_encodings/supply/{}_{}_augReduce_Thr{}{}.npz'.format(args.dataset, encoding_dim, threshold, t)
        aug_label, stable_clu, stable_center, reduced_clu, reduced_pos = get_aug_reduced_label(samples, embs, cluter_center, augZ_file, augReduce_file, args.dataset, weak, threshold,device)
        # aug_label = None 
        # aug_label = samples['Y']  
    ...
    model = models.get_model(model_name=exp_dict["model"]['name'], backbone=backbone, 
                                 ...
                                 exp_dict=exp_dict,
                                 pretrained_weights_dir=pretrained_weights_dir, checkpoint=args.checkpoint,
                                 savedir_base=savedir_base,
                                 data = samples, center = cluter_center, device=device)
    ...
    for epoch in range(s_epoch, exp_dict["max_epoch"]):
        ...
        score_dict.update(model.train_on_loader(train_loader,pem_eta=pem_eta)) # no new samples
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume_config', type=str, default=None, help='config path for resume.')
    parser.add_argument('--checkpoint', type=str, default=None, help='checkpoint uesd to resume.')
