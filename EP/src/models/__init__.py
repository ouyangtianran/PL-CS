...
def get_model(model_name, backbone, n_classes, exp_dict, pretrained_weights_dir=None, checkpoint = None, savedir_base=None, data = None, center = None, aug_label = None, device=None):
    if model_name == "pretraining":
        ...
        model =  finetuning_un.FinetuneWrapper(backbone, n_classes, exp_dict, data=data, center=center, aug_label=aug_label, checkpoint=checkpoint,device=device)
