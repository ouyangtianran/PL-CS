...
def get_dataset(dataset_name, 
                ...
                query_size, 
                unlabeled_size,
                n_iters, filename = None, aug_label=None):
    ...
    if dataset_name == "rotated_omniglot":
        ...
        dataset = RotatedNonEpisodicOmniglotEn(data_root,
                                          split,
                                          transform_func, filename = filename, aug_label=aug_label)
        ...
        dataset = EpisodicOmniglotEn(data_root=data_root,
                                       ...
                                       sampler=few_shot_sampler,
                                       size=n_iters,
                                       transforms=transform_func, filename = filename, aug_label=aug_label)
