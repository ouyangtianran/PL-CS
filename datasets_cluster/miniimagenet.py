...
class MiniImagenet(CombinationMetaDataset):
    ...
    def __init__(self, root, num_classes_per_task=None, meta_train=False,
                 ...
                 class_augmentations=None, download=False, folder = None,filename = None, aug_label = None):
        dataset = MiniImagenetClassDataset(root, meta_train=meta_train,
                                           meta_val=meta_val, meta_test=meta_test, meta_split=meta_split,
                                           transform=transform, class_augmentations=class_augmentations,
                                           download=download, folder = folder,filename = filename, aug_label = aug_label)
...
class MiniImagenetClassDataset(ClassDataset):
    ...
    def __init__(self, root, meta_train=False, meta_val=False, meta_test=False,
                 ...
                 download=False, folder = None,filename = None, aug_label = None):
        ...
        self.split_filename = os.path.join(self.root, filename)
